      ...
      <section className="flex justify-between items-center shrink-0 py-2 px-4 md:px-0 container mx-auto relative">
        ...
        <nav className="hidden md:block">
          <ul className="flex justify-between items-center gap-5">
            ...
            <li><Link to='/about' className="hover:text-cyan-400">À propos</Link></li>
            <li><Link to='/services' className="hover:text-cyan-400">Services</Link></li>
            <li><Link to='/pricing' className="hover:text-cyan-400">Packs</Link></li>
            <li><Link to='/contact' className="hover:text-cyan-400">Contact</Link></li>
          </ul>
        </nav>
        <button className="hidden md:flex justify-center items-center gap-2 px-2 py-1 group hover:bg-Alpha transition duration-300 ease-in rounded-xl" title="call-opt">
          ...
          <p className="text-left leading-5 group-hover:text-Dark"><ButtonMailto label="Appelez-nous <br />+212 7 62 86 16 97" sendto="tel:212762861697" /></p>
        </button>
