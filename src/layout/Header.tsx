...
export default function Header() {
  ...
  return(
    <header className="fixed inset-x-0 w-full backdrop-blur bg-Beta-secondary/20 z-10">
      <style>{css}</style>
      <section className="flex justify-between items-center shrink-0 py-2 container mx-auto ">
